...
const config = {
  ...
  // Nenhum dos dois é segredo — client e slot do AdSense vão de qualquer
  // forma parar em HTML público. Vazio = sem anúncio nenhum (padrão do
  // dev local e de quem não quiser rodar isso).
  adsense: {
